 ...
 */
public class RestClient_gPPD extends TestBase {
    final static Logger Log = Logger.getLogger(RestClient_gPPD.class);
   ...
   用來調用只有接口URL沒有參數的接口
   */
    public CloseableHttpResponse postGet (String url, HashMap<String,String> headermap) throws ClientProtocolException, IOException {
        //创建一个可关闭的HttpClient对象
        CloseableHttpClient httpclient = HttpClients.createDefault();
        //创建一个HttpPost的请求对象
        HttpPost httppost = new HttpPost(url);
